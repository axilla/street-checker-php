...
/**
 * Controller for all actions with User object.
...
class APIUserController extends Controller
{
     ...
     * @Rest\View
     * @ApiDoc(
     *  description="Show User profile of currently logged user",
     *  statusCodes = {
     *     200 = "Returned when successful",
     *     404 = "Returned when User not found"
     *   },
    ...
    public function showMeAction(Request $request)
    {
        ...
        $userSer->comments = $user->getComments()->count();
        $userSer->reports = $user->getReports()->count();
        $userSer->responses = $user->getResponses()->count();
